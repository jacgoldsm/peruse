...
I'm excited to announce that [peruse 0.1.0](https://jacgoldsm.github.io/peruse/) is now
available on CRAN!

NOTE: {peruse} is undergoing major changes. Install the development version for the most recent version with
```{r, eval = FALSE} 
devtools::install_github("jacgoldsm/peruse")
```

Those changes should be added to CRAN some time during January 2021 under the name `peruse 0.2.0`.
