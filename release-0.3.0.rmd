...
This illustrates a two useful features of Iterators:

* We can use environment variables in either our expression or our `while` condition to represent constants. In this case, `threshold` doesn't change between iterations or between parameters.
